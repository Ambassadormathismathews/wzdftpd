...
OutputBaseFilename=wzdftpd-0.5cvs-20041214-2
...
Source: ..\release\libwzd_core.dll; DestDir: {app}; Flags: ignoreversion
Source: ..\libwzd\release\libwzd.dll; DestDir: {app}; Flags: ignoreversion
