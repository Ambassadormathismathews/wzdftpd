...
AppName=wzdftpd
AppVerName=wzdftpd debug 0.5cvs-20041214
AppPublisher=pollux
...
OutputBaseFilename=wzdftpd-debug-0.5cvs-20041214-2
...
Source: ..\backends\mysql\debug\libwzd_mysql.dll; DestDir: {app}\backends; Flags: ignoreversion
