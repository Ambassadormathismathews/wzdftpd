...
;Languages
  ...
  LangString DESC_TCLSec ${LANG_GERMAN} "Optionales TCL-Module."
  LangString DESC_PerlSec ${LANG_GERMAN} "Optionales Perl-Module."
  ...
  LangString CAPT_PerlSec ${LANG_GERMAN} "Perl-Module"
