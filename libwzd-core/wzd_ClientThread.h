...
int clear_read(socket_t sock, char *msg, size_t length, int flags, unsigned int timeout, void * vcontext);
int clear_write(socket_t sock, const char *msg, size_t length, int flags, unsigned int timeout, void * vcontext);
